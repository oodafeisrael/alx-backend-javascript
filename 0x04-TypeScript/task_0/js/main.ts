...
tdata.innerHTML = "Some content"; // Provide valid HTML content here
tdata1.innerHTML = "Some content"; // Provide valid HTML content here
...
tdata2.innerHTML = "Some content"; // Provide valid HTML content here
tdata3.innerHTML = "Some content"; // Provide valid HTML content here
